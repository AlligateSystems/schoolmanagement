...
@Controller
public class School2_BonafideController {

	@Autowired
	Environment env;

	@Autowired
	School2_StudentRepository repository;

	@GetMapping("/school2/bonafide")
	public ModelAndView attendance() {
		ModelAndView modelAndView = new ModelAndView("school2/bonafide");
		modelAndView.addObject("pageTitle", "Get Bonafide");
		return modelAndView;
	}

//	@GetMapping("/school2/bonafide/{registerNumber}")
//	public void dashboard(@PathVariable(value = "registerNumber") String registerNumber, HttpServletResponse response) {
//		School2_StudentEntity student = repository.findByRegisterNumber(registerNumber);
//		try {
//			ClassPathResource cpr = new ClassPathResource(env.getProperty("school2.bonafide_certificate.doc.filePath"));
...
//	}
	...
	public void dashboard(@PathVariable(value = "registerNumber") String registerNumber, HttpServletResponse response) {
		...
		try {
			...
			File file = new File("Temp_SC2_Bonafide.docx");
