...
public class School2_LeavingController {
	...
	@GetMapping("/school2/leaving")
	public ModelAndView attendance() {
		ModelAndView modelAndView = new ModelAndView("school2/leaving");
	...
	@GetMapping("/school2/leaving/{registerNumber}")
	public void dashboard(@PathVariable(value = "registerNumber") String registerNumber, HttpServletResponse response) {
		...
		try {
			ClassPathResource cpr = new ClassPathResource(env.getProperty("school2.leaving_certificate.doc.filePath"));
